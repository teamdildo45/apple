...
NC='\033[0m'
echo ""
printf "$RED   ___     ___     _       ___     ___    _ _      ___   $GRN#\n"
printf "$RED  |   \   |_ _|   | |     |   \   / _ \  | | |    | __|  $GRN##\n"
printf "$RED  | |) |   | |    | |__   | |) | | (_) | |_  _|   |__ \  $GRN###\n"
printf "$RED  |___/   |___|   |____|  |___/   \___/   _|_|_   |___/  $GRN####\n"
printf "$RED           o-o   o-O-o O---oo-o    o-o    o o-o          $GRN####\n"
printf "$NC\n"
cat <<EOF
			- DILDO -
          [+] anonymoushc25@hotmail.com [+]
        
---------------------------------------------------
   DILDO45 Family - AppleID Validator 2018
---------------------------------------------------
...
echo "[+] Doing an automatic update from server on `date`"
updater "auto"
...
if [[ $inputFile == '' ]]; then
  ...
  # clear
  tree
  read -p "nama file list lu: " inputFile
fi

if [[ $targetFolder == '' ]]; then
  read -p "nama folder: " targetFolder
...
malhadi_appleval() {
  ...
  footer="[dildo team - AppleValid 2018] $(($duration % 60))sec.\n"
